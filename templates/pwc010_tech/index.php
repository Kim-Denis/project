...
<?php endif; ?>
<?php echo artxPositions($this, array('user1', 'user2'), 'artblock'); ?>
...
<?php echo artxPositions($this, array('user4', 'user5'), 'artblock'); ?>
...
<p><br/>
&copy; 2009 <a href="index.php"><?php echo $mainframe->getCfg('sitename') ;?></a></p>
