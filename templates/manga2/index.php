...
<div class="logo">
 <h1 id="name-text" class="logo-name"><a href="<?php echo $this->baseurl ?>/">Manga V2</a></h1>
...
<div class="cleared"></div>
<p class="page-footer">Designed by <a href="http://www.joomla.server.deutschland.de">joomla.server.deutschland.de</a>.</p>
</div>
